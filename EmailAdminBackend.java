...
public void emp_Name_Creation(){
	...
	public void empDepartment(){
		...
		do{
			...
			if(emp_Department==1){
		System.out.println("You are  department is: Development");}
			else if(emp_Department==2){
				System.out.println("You Are Department Is: Testing");
			}
			else if(emp_Department==3){
				System.out.println("Your Are Department Is: Maintanance");
			}
			else if(emp_Department==4){
				System.out.println("You Are Department Is: Teamlead");
			}
			else{
				System.out.println("--------------You Are Choosing wrong Option-----------------------------------------------------");
				empDepartment();
			}break;
